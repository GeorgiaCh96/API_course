...
#from tests.test_posts import (test_create_post, test_delete_post_success,
#    test_unauthorized_user_create_post)
...
def test_updated_other_user_post(authorized_client, test_user, test_user2, test_posts):
    data = {
        "title": " updated title",
        "content": "updated content",
        "id": test_posts[3].id
